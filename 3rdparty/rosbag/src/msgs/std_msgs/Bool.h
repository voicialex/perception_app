...
namespace std_msgs {
template <class ContainerAllocator> struct Bool_ {
    typedef Bool_<ContainerAllocator> Type;

    Bool_() : data(false) {}
    Bool_(const ContainerAllocator &_alloc) : data(false) {
        (void)_alloc;
    }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::std_msgs::Bool_<ContainerAllocator> &v) {
    orbbecRosbag::message_operations::Printer<::std_msgs::Bool_<ContainerAllocator>>::stream(s, "", v);
    return s;
}
...
template <class ContainerAllocator> struct IsFixedSize<::std_msgs::Bool_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::std_msgs::Bool_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::std_msgs::Bool_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::std_msgs::Bool_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::std_msgs::Bool_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::std_msgs::Bool_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct MD5Sum<::std_msgs::Bool_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<::std_msgs::Bool_<ContainerAllocator>> {
    static const char *value() {
...
template <class ContainerAllocator> struct Definition<::std_msgs::Bool_<ContainerAllocator>> {
    static const char *value() {
        return "bool data\n\
";
    }
...
template <class ContainerAllocator> struct Printer<::std_msgs::Bool_<ContainerAllocator>> {
