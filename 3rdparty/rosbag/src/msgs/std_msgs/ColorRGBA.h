...
namespace std_msgs {
template <class ContainerAllocator> struct ColorRGBA_ {
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::std_msgs::ColorRGBA_<ContainerAllocator> &v) {
    orbbecRosbag::message_operations::Printer<::std_msgs::ColorRGBA_<ContainerAllocator>>::stream(s, "", v);
    return s;
}
...
template <class ContainerAllocator> struct IsFixedSize<::std_msgs::ColorRGBA_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::std_msgs::ColorRGBA_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::std_msgs::ColorRGBA_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::std_msgs::ColorRGBA_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::std_msgs::ColorRGBA_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::std_msgs::ColorRGBA_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct MD5Sum<::std_msgs::ColorRGBA_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<::std_msgs::ColorRGBA_<ContainerAllocator>> {
    static const char *value() {
...
template <class ContainerAllocator> struct Definition<::std_msgs::ColorRGBA_<ContainerAllocator>> {
    static const char *value() {
        return "float32 r\n\
float32 g\n\
float32 b\n\
...
template <class ContainerAllocator> struct Printer<::std_msgs::ColorRGBA_<ContainerAllocator>> {
