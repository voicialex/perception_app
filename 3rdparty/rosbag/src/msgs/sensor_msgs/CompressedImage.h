...
template <class ContainerAllocator> struct CompressedImage_ {
    typedef CompressedImage_<ContainerAllocator> Type;

    CompressedImage_() : header(), format(), data(), width(0), height(0), timestamp_usec(0) {}
    CompressedImage_(const ContainerAllocator &_alloc) : header(_alloc), format(_alloc), data(_alloc), width(0), height(0), timestamp_usec(0) {
        (void)_alloc;
    }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::sensor_msgs::CompressedImage_<ContainerAllocator> &v) {
    orbbecRosbag::message_operations::Printer<::sensor_msgs::CompressedImage_<ContainerAllocator>>::stream(s, "", v);
    return s;
}
...
template <class ContainerAllocator> struct IsFixedSize<::sensor_msgs::CompressedImage_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::sensor_msgs::CompressedImage_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct IsMessage<::sensor_msgs::CompressedImage_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::sensor_msgs::CompressedImage_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::sensor_msgs::CompressedImage_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::sensor_msgs::CompressedImage_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::sensor_msgs::CompressedImage_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<::sensor_msgs::CompressedImage_<ContainerAllocator>> {
    static const char *value() {
...
template <class ContainerAllocator> struct Definition<::sensor_msgs::CompressedImage_<ContainerAllocator>> {
    static const char *value() {
...
uint16 width	           # Compressed image width\n\
uint16 height	           # Compressed image height\n\
uint64_t timestamp_usec  # Compressed image timestamp when it captured \
\n\
================================================================================\n\
MSG: std_msgs/Header\n\
...
template <class ContainerAllocator> struct Printer<::sensor_msgs::CompressedImage_<ContainerAllocator>> {
