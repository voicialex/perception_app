...
template <class ContainerAllocator> struct Imu_ {
    ...
    Imu_(const ContainerAllocator &_alloc)
        : header(_alloc),
          ...
          number(_alloc),
          temperature(_alloc),
          timestamp_usec(_alloc),
          timestamp_systemusec(_alloc),
          timestamp_globalusec(_alloc) {
        (void)_alloc;
        orientation_covariance.fill(0.0);
    ...
    typedef uint32_t _datasize_type;
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::sensor_msgs::Imu_<ContainerAllocator> &v) {
    orbbecRosbag::message_operations::Printer<::sensor_msgs::Imu_<ContainerAllocator>>::stream(s, "", v);
    return s;
}
...
template <class ContainerAllocator> struct IsFixedSize<::sensor_msgs::Imu_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::sensor_msgs::Imu_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct IsMessage<::sensor_msgs::Imu_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::sensor_msgs::Imu_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::sensor_msgs::Imu_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::sensor_msgs::Imu_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::sensor_msgs::Imu_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<::sensor_msgs::Imu_<ContainerAllocator>> {
    static const char *value() {
...
template <class ContainerAllocator> struct Definition<::sensor_msgs::Imu_<ContainerAllocator>> {
    static const char *value() {
...
uint64 timestamp_systemusec\n\
uint64 timestamp_globalusec \n\
\n\
================================================================================\n\
MSG: std_msgs/Header\n\
...
template <class ContainerAllocator> struct Printer<::sensor_msgs::Imu_<ContainerAllocator>> {
